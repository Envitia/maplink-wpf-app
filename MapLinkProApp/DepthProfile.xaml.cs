...
namespace MapLinkProApp
{
  ...
  /// </summary>
  public partial class DepthProfileWindow : Window
  {
    public DockableWindow Dockable { get; private set; }

    private LayerSelector LayerSelector { get; set; }

    public DepthProfileWindow(DockableWindow dockable)
    {
      InitializeComponent();  
    ...
    {
      StackPanel layersPanel = (StackPanel)this.FindName("DepthProfileLayersPanel");
      ...
      ProfilePanel.Initialise(crossSection);
    }
    ...
    {
      StackPanel element = (StackPanel)this.FindName("DepthProfileLayersPanel");
    ...
    public void OnLayerChanged(object sender, EventArgs e)
    {
      ...
      ProfilePanel.UpdateCrossSection(layer);
    }
  }
}
